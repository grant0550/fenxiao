...
class Index_EweiShopV2Page extends AppMobilePage
{
	...
	public function cacheset()
	{
		...
		if (empty($noset)) {
			$arr['sysset'] = array('shopname' => $_W['shopset']['shop']['name'], 'shoplogo' => $_W['shopset']['shop']['logo'], 'description' => $_W['shopset']['shop']['description'], 'share' => $_W['shopset']['share'], 'texts' => array('credit' => $_W['shopset']['trade']['credittext'], 'money' => $_W['shopset']['trade']['moneytext']), 'hidekefu' => $_W['shopset']['app']['hidekefu']);
