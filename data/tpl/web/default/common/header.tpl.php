	...
	<nav class="navbar navbar-default" role="navigation">
		<div class="container <?php  if(!empty($frames['section']['platform_module_menu']['plugin_menu'])) { ?>plugin-head<?php  } ?>">
			...
			<div class="collapse navbar-collapse">
				...
				<?php  $url=url('account/display')?>
				<?php  $nav_top_fold[] = array('name' => 'all', 'title'=>'全部', 'type' => 'all', 'url' => $url)?>
				...
				<?php  if(is_array($top_nav)) { foreach($top_nav as $nav) { ?>
					...
					<?php  } else if(in_array($nav['name'], array('module', 'system', 'site'))) { ?>
				...
				<ul class="nav navbar-nav  navbar-left">
					<?php  if($_GPC['active'] == 'privileges' || in_array($_GPC['type'], array(ACCOUNT_TYPE_SIGN, WXAPP_TYPE_SIGN, WEBAPP_TYPE_SIGN, PHONEAPP_TYPE_SIGN, 'all'))) { ?>
						<?php  $privileges_active = true?>
					<?php  } ?>
					<li <?php  if($privileges_active) { ?> class="active" <?php  } ?>><a href="<?php  echo url('account/display/platform', array('active' => 'privileges'))?>">平台</a></li>
